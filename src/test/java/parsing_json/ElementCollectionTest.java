...
public class ElementCollectionTest {
    private ElementCollection<Element> elements;
    ...
    @Test
    public void findByAtomicNumber() throws Exception {
    ...
    public void where() throws Exception {
        ElementCollection<Element> expected = new ElementCollection() {{add(new Element(
                "Hydrogen",
                "colorless gas",
                1.008,
                20.271,
